...
The [SRML Contracts module](../smart-contracts/contracts-pallet) provides functionality
...
The [SRML EVM module](../smart-contracts/evm-pallet) provides an EVM execution
...
[ink!](../smart-contracts/ink-fundamentals) is a Rust-based eDSL for writing Wasm smart contracts specifically for the [Contracts module](#contracts-module). It is designed for correctness, conciseness and efficiency.
...
- Investigate the [EVM pallet](../smart-contracts/evm-pallet) to see if it is what
  you need for your next project.
- Read about the [ink! smart contract language](../smart-contracts/ink-fundamentals).
